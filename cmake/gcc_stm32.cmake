...
FUNCTION(STM32_PRINT_SIZE_OF_TARGETS TARGET)
    IF(EXECUTABLE_OUTPUT_PATH)
      SET(FILENAME "${EXECUTABLE_OUTPUT_PATH}/${TARGET}${BINARY_POSTFIX}")
    ELSE()
      SET(FILENAME "${TARGET}${BINARY_POSTFIX}")
    ENDIF()
...
FUNCTION(STM32_SET_TARGET_PROPERTIES TARGET)
    ...
    MESSAGE(STATUS "${STM32_CHIP} has ${STM32_FLASH_SIZE}iB of flash memory, ${STM32_RAM_SIZE}iB of RAM and ${STM32_CCRAM_SIZE}iB of CCRAM")
ENDFUNCTION()
