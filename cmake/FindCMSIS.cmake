...
ELSEIF(STM32_FAMILY STREQUAL "F3")
    IF(NOT STM32Cube_DIR)
        SET(STM32Cube_DIR "/opt/STM32Cube_FW_F3_V1.10.0")
        MESSAGE(STATUS "No STM32Cube_DIR specified, using default: " ${STM32Cube_DIR})
    ENDIF()
...
ELSEIF(STM32_FAMILY STREQUAL "F0")
    ...
    STM32_GET_CHIP_TYPE(${STM32_CHIP} STARTUP_TYPE)
    SET(CMSIS_STARTUP_SOURCE startup_stm32f${STARTUP_TYPE}.s)
    MESSAGE(STATUS "STM32_STARTUP_NAME is " ${STARTUP_TYPE})
    LIST(APPEND CMSIS_COMMON_HEADERS core_cm3.h)
...
ENDIF()
MESSAGE(STATUS "CMakeStartup name is " ${STM32_CODE})
