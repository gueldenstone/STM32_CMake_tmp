...
MACRO(STM32_GET_CHIP_TYPE CHIP CHIP_TYPE)
    STRING(REGEX REPLACE "^[sS][tT][mM]32[fF](3[037][1234].[68BCDE]).*$" "\\1" STM32_CODE ${CHIP})
    SET(INDEX 0)
...
MACRO(STM32_GET_CHIP_PARAMETERS CHIP FLASH_SIZE RAM_SIZE CCRAM_SIZE)
    STRING(REGEX REPLACE "^[sS][tT][mM]32[fF](3[037][1234].[68BCDE]).*$" "\\1" STM32_CODE ${CHIP})
    STRING(REGEX REPLACE "^[sS][tT][mM]32[fF]3[037][1234].([68BCDE]).*$" "\\1" STM32_SIZE_CODE ${CHIP})

    MESSAGE(STATUS "STM32_CODE ist  ${STM32_CODE}")
    MESSAGE(STATUS "STM32_SIZE_CODE ist  ${STM32_SIZE_CODE}")
    ...
    MESSAGE(STATUS "STM32_CCRAM_SIZE ist  ${STM32_CCRAM_SIZE}")
ENDMACRO()
...
FUNCTION(STM32_SET_CHIP_DEFINITIONS TARGET CHIP_TYPE)
    ...
    ENDIF()
    MESSAGE("Setting Target Properties with ${TARGET_DEFS}")
